...
import com.idit.dialog.PairedDevicesDialog;
import com.idit.utility.MyLog;
    ...
    {        
        switch (mCMDPointer)
        {
            ...
            case 2: // CMD: 0105, Engine coolant temperature
                ...
                mSbCmdResp.append("R>>");
                mSbCmdResp.append(buffer);
                mSbCmdResp.append( " (Motor. La temperatura del refrigerante es: ");
            ...
            case 4: // CMD: 010D, Vehicle Speed
                ...
                mSbCmdResp.append("R>>");
                mSbCmdResp.append(buffer);
                mSbCmdResp.append( " (Velocidad del vehiculo: ");
            ...
            case 5: // CMD: 0131
                ...
                mSbCmdResp.append("R>>");
                mSbCmdResp.append(buffer);
                mSbCmdResp.append( " (Distancia recorrida desde que se borraron los códigos: ");
